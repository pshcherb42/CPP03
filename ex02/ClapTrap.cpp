...
ClapTrap::ClapTrap() : _name("Default Name"),  _hpoints(100), _epoints(100), _damage(30) {
    std::cout << "ClapTrap default constructor called" << std::endl;
};

ClapTrap::ClapTrap(std::string const& name) : _name(name), _hpoints(100), _epoints(100), _damage(30) {
